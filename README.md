...
<table>
  <tr>
    <td align="center"><img src="docs/images/scan-camera.png" width="240" alt="Camera-first Scan screen" /><br /><sub>Camera-first Scan</sub></td>
    <td align="center"><img src="docs/images/scan-photo-ready.png" width="240" alt="Photo ready for analysis" /><br /><sub>Photo Ready</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="docs/images/results-generic.png" width="240" alt="Generic detection results" /><br /><sub>Generic Results</sub></td>
    <td align="center"><img src="docs/images/results-detailed.png" width="240" alt="Detailed detection results" /><br /><sub>Detailed Results</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="docs/images/results-selection.png" width="240" alt="Synchronized box and row selection" /><br /><sub>Synchronized Selection</sub></td>
    <td align="center"><img src="docs/images/results-list.png" width="240" alt="Long result list" /><br /><sub>Result List</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="docs/images/settings.png" width="240" alt="Gemini API key settings" /><br /><sub>BYOK Settings</sub></td>
    <td></td>
  </tr>
</table>
